...
```{r fig.height = 20, fig.width=20, fig.cap="*Heatmap of log fold changes across different comparisons for genes that were significant in at least 1 pairwise comparison aganst controls*"}
