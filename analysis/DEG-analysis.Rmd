...
summary_DEG = summary(results) %>% melt() %>% 
    ...
    scale_fill_manual(values = c( "#2F124B","#EA2A5F")) +
...
#       units = c("in"), height = 5.54, width = 5.69)
...
#ggsave(filename = "/home/neuro/Documents/NMD_analysis/Analysis/NMD-analysis/output/DEG/Thesis_figures/ratio_DEG.svg", plot = ratios, 
#       units = c("in"), height = 4, width = 5.69)
